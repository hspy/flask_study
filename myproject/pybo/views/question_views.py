...
from flask import Blueprint, render_template #rendering template
...
def detail(question_id):
    ...
    return render_template('question/question_detail.html', question=question) #question render, render html